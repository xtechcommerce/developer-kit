...
(function ($) {
    ...
    Checkout.prototype = {
        ...
        setPaymentDiscount: function(module){
            $.post(site_url.base + 'checkout/set_payment_method', {module: module}, $.proxy(this.updateSummary, this), 'json');
        },
        ...
        updateCart: function(method, e) {
            $.post(site_url.base + 'checkout/set_shipping_method', {shipping_method: method, zip: $('#zip_code').val()}, $.proxy(this.updateSummary, this), 'json');
        },
